...
//          switch (selectedDot.linenumber){
//              case 0:
//                  Toast.makeText(getContext(), "Tugas Akademik", Toast.LENGTH_SHORT).show();
//              case 1:
//                  Toast.makeText(getContext(), "Tugas Organisasi", Toast.LENGTH_SHORT).show();
//              case 2:
//                  Toast.makeText(getContext(), "Tugas Lain Lain", Toast.LENGTH_SHORT).show();
//
//          }
